...
Algoritmo ejercicio_extra8
	...
	caratulaPresentacion(logo)
	inicializarMatrizCeros(matrizDatos)
	generarDatosAleatorios(matrizDatos)
	menuVisualizacionDatos(matrizFinal,matrizDatos,logo, caratulaVendedores, caratulaVentas, caratulaRendimiento)
FinAlgoritmo

SubProceso menuVisualizacionDatos(matrizFinal,matrizDatos,logo, caratulaVendedores, caratulaVentas,caratulaRendimiento)
	...
	Hacer
		Borrar Pantalla
		imprimirImagen(260," ",caratulaVendedores,5,2,1)
		centrar(260," ", "SLECCIONE UNA OPCION")
		centrar(260," ", "1 - Buscar datos de vendedores")
		centrar(260," ", "2 - Total de Ventas Zona Centro")
		centrar(260," ", "3 - Total de Ventas Zona Norte")
		centrar(260," ", "4 - Total de Ventas Zona Este")
		centrar(260," ", "5 - Total de Ventas Zona Sur")
		centrar(260," ", "6 - Total de Ventas Zona Oeste")
		centrar(260," ", "7 - Total de Ventas en Todas las Zonas")
		centrar(260," ", "8 - Total de Ventas de Vendedor")
		centrar(260," ", "S - Salir ")
		Leer seleccion
		...
		Segun seleccion
			"1":
				pedirNombreVendedores(matrizFinal,caratulaVendedores)
				titulosFilasColumnasPrincipales(matrizFinal)
				armarTablaFinal(matrizFinal, matrizDatos)
				bandera = VERDADERO 
			"2":
				Si bandera Entonces
					imprimirTablaVentasPorZonas(seleccion,caratulaVentas,matrizFinal)
					esperarRespuestaUsuario(260)
				SiNo
					imprimirImagen(260," ",caratulaVendedores,5,2,1)
					centrar(260," ", "DEBE SELECCIONAR LOS VENDEDORES PRIMERO")
					esperarRespuestaUsuario(260)
				FinSi
			"3":
				Si bandera Entonces
			...
			"7":
				Si bandera Entonces
					imprimirTablaVentas(matrizFinal,12,8,caratulaVentas)
					esperarRespuestaUsuario(260)
				SiNo
					imprimirImagen(260," ",caratulaVendedores,5,2,1)
					centrar(260," ", "DEBE SELECCIONAR LOS VENDEDORES PRIMERO")
			...
			"8":
				Si bandera Entonces
					Hacer						
						...
						Segun seleccion
							"1":
								imprimirTablaRendimientoPorVendedor(seleccion,matrizFinal,12,8, caratulaRendimiento)
								esperarRespuestaUsuario(260)
							"2":
								imprimirTablaRendimientoPorVendedor(seleccion,matrizFinal,12,8, caratulaRendimiento)
								esperarRespuestaUsuario(260)
							...
							"4":
								...
								esperarRespuestaUsuario(260)
							"5":
								imprimirTablaRendimiento(matrizFinal,12,8,caratulaRendimiento)
								esperarRespuestaUsuario(260)
						FinSegun
				...
				FinSi
			"s","salir":
				imprimirImagen(265," ",logo,9,15,15)
				Esperar 1500 Milisegundos
				centrar(265," ", "FIN DEL PROGRAMA")
		FinSegun
...
SubProceso imprimirTablaRendimientoPorVendedor(seleccion,matrizFinal,fila,columna, caratulaRendimiento)
	Definir i,j, ancho Como Entero	
	ancho = maximaCantidadDigitos(matrizFinal)
	imprimirImagen(260," ",caratulaRendimiento,8,2,1)
	
	renglonSuperior(46,ancho,columna-1)
	inicioRenglonIntermedio(45)
...
SubProceso imprimirTablaRendimiento(matrizFinal,fila,columna,caratulaRendimiento)
	Definir i,j, ancho Como Entero	
	ancho = maximaCantidadDigitos(matrizFinal)
	imprimirImagen(260," ",caratulaRendimiento,8,2,1)
	renglonSuperior(46,ancho,columna-1)
...
SubProceso imprimirTablaVentasPorZonas(seleccion,caratulaVentas,matrizFinal)
	Definir i,j,ancho Como Entero
	ancho = maximaCantidadDigitos(matrizFinal)
	imprimirImagen(260," ",caratulaVentas,8,2,1)
	renglonSuperior(106,ancho,2)
	para i = 0 Hasta 6 Hacer
		inicioRenglonIntermedio(105)
		centrarSinSaltar(ancho," ",matrizFinal[i,0])
		centrarSinSaltar(ancho," ",matrizFinal[i,ConvertirANumero(seleccion)-1])
		finRenglonIntermedio()
		renglonInferior(105,ancho,2)
	FinPara
	Escribir ""
FinSubProceso

SubProceso imprimirTablaVentas(matrizFinal,fila,columna,caratulaVentas)
	Definir i,j, ancho Como Entero
	ancho = maximaCantidadDigitos(matrizFinal)
	imprimirImagen(260," ",caratulaVentas,8,2,1)
	renglonSuperior(31,ancho,columna)
	para i = 0 Hasta 6 Hacer
		inicioRenglonIntermedio(30)
		Para j = 0 Hasta columna-1 Hacer			
			centrarSinSaltar(ancho," ",matrizFinal[i,j])
		FinPara
		finRenglonIntermedio()
		renglonInferior(30,ancho,columna)
	FinPara
	Escribir ""
FinSubProceso
...
SubProceso pedirNombreVendedores(matrizFinal,caratulaVendedores)
	Definir i Como Entero
	...
	Para i = 1 Hasta 3 Hacer
		Escribir ""
	FinPara
	centrar(260," ", "<<<<PRESIONE UNA TECLA>>>>")
	Esperar Tecla
	Borrar Pantalla
FinSubProceso
...
SubProceso caratulaPresentacion(logo)
	...
	imprimirImagen(265," ",logo,9,15,15)
	Esperar 1500 Milisegundos
	centrarSinSaltar(265," ", "<<<<PRESIONE UNA TECLA>>>>")
	Esperar Tecla
	Borrar Pantalla
FinSubProceso
